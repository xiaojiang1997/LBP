...
####Model 1####
variable.names <- c("OHNa_1.cut","OHNa_2.cut","OHFlu_2.cut","OHFlu_3.cut","OHPh_1.cut","OHPh_23.cut","OHP_1.cut", "OH_ALL.cut","LBP")
...
write.csv(lg0.result,"lg0p.result.csv")
...
write.csv(lg1.result,"lg1p.result.csv")
...
write.csv(lg2.result,"lg2p.result.csv")
